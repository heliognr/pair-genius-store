...
// Reusing logic from QuestionMarkIconComponent
const QuestionMarkEmojiIconComponent: React.FC<SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
...
export default QuestionMarkEmojiIconComponent;
